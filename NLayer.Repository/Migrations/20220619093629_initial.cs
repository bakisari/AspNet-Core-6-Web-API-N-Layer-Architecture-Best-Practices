    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 6, 19, 12, 36, 28, 774, DateTimeKind.Local).AddTicks(7735), "Faber Castel", 100m, 65, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "id", "CategoryId", "CreateDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 2, 2, new DateTime(2022, 6, 19, 12, 36, 28, 774, DateTimeKind.Local).AddTicks(7749), "Kareli Defter", 16m, 145, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "id", "CategoryId", "CreateDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 3, 3, new DateTime(2022, 6, 19, 12, 36, 28, 774, DateTimeKind.Local).AddTicks(7751), "Son On Saniye", 12m, 50, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
